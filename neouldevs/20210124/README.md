...
- [1. 3장 - 아키텍처](#1-3장---아키텍처)
  - [1.1. 전체 구조](#11-전체-구조)
  - [1.2. MySQL 스레딩 구조](#12-mysql-스레딩-구조)
  - [1.3. 메모리 할당 및 사용 구조](#13-메모리-할당-및-사용-구조)
  - [1.4. 플러그인 스토리지 엔진 모델](#14-플러그인-스토리지-엔진-모델)
  - [1.5. 쿼리 실행 구조](#15-쿼리-실행-구조)
  - [1.6. 레플리케이션](#16-레플리케이션)
  - [1.7. 쿼리 캐시](#17-쿼리-캐시)
  - [2.1. InnoDB 스토리지 엔진 특성](#21-innodb-스토리지-엔진-특성)
  - [2.2. InnoDB 버퍼 풀](#22-innodb-버퍼-풀)
  - [2.3. 언두(Undo) 로그](#23-언두undo-로그)
  - [2.4. 인서트 버퍼(Insert Buffer)](#24-인서트-버퍼insert-buffer)
  - [2.5. 리두(Redo) 로그 및 로그 버퍼](#25-리두redo-로그-및-로그-버퍼)
  - [2.6. MVCC](#26-mvcc)
  - [2.7. Non-Locking consistent read](#27-non-locking-consistent-read)
- [2. 4장 - 트랜잭션](#2-4장---트랜잭션)
  - [1.2. 주의사항](#12-주의사항)
...
## 2.7. Non-Locking consistent read
...
커넥션과 동일한 주의 사항으로, 꼭 필요한 최소의 코드에만 적용할 것.  
